...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '☬𝕯𝖊𝖊𝖕𝖉𝖎𝖆☬;Dark Deep;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "☬𝕯𝖊𝖊𝖕𝖉𝖎𝖆☬",
    BOT_NAME: process.env.BOT_NAME || '☬𝕯𝖊𝖊𝖕𝖉𝖎𝖆☬',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭☬𝕯𝖊𝖊𝖕𝖉𝖎𝖆☬¹ꫂ;Dark MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
